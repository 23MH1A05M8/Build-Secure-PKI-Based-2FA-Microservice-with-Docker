...
# 6. Docker Image URL
echo "Docker image URL for evaluation: 23mh1a05m8/build-secure-pki-based-2fa-microservice-with-docker-app:latest"
echo "Docker Hub link: https://hub.docker.com/r/23mh1a05m8/build-secure-pki-based-2fa-microservice-with-docker-app"
